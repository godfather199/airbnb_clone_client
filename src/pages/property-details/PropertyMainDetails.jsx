...
const details_Info = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
        <rect fill="#ebebeb" height="5" rx="5" width="5"></rect>
        <path
  ...
  },
  {
    ...
    subtitle: "You'll share parts of the home",
  },
  {
    icon: (
      <svg
    ...
    subtitle: "This place has a bathroom thats connected to your room.",
  },
  {
    icon: (
      <svg
